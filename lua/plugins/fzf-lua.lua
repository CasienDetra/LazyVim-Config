...
M.config = function()
    ...
    -- Finding a word
    vim.keymap.set("n", "<leader>fw", fzf.blines, { desc = "[/] Search words in the buffer" })
    ...
    -- Git
    vim.keymap.set("n", "<leader>fgc", fzf.git_commits, { desc = "Search [G]it [C]ommits" })
    vim.keymap.set("n", "<leader>fgs", fzf.git_status, { desc = "Search [G]it [S]tatus" })
